...
import NavLinkAdapter from '@shared/fuse/core/NavLinkAdapter'
...
function FuseNavVerticalCollapse(props) {
  ...
  const itempadding = nestedLevel > 0 ? 38 + nestedLevel * 2 : 16
        ...
        >
          ...
          >
            <FuseSvgIcon size={16} className='arrow-icon' color='inherit'>
              {open ? 'heroicons-solid:chevron-down' : chevronIcon}
            </FuseSvgIcon>
          </IconButton>
        </ListItem>
